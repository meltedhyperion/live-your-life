  ...
  const handleAnswer = async (answer: string) => {
    ...
    try {
      const url = accessToken
        ...
        : `${import.meta.env.VITE_BACKEND_API}/questions/check/guest`;
      ...
      // Update guest stats in sessionStorage if in guest mode
      if (!accessToken) {
        let guestTotal = Number(sessionStorage.getItem("guest_total") || "0");
        let guestCorrect = Number(
        ...
        sessionStorage.setItem("guest_total", guestTotal.toString());
        sessionStorage.setItem("guest_correct", guestCorrect.toString());
      }
        ...
        {!answerResult ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <HeadoutButton city={answerResult.correct_answer} />
            </div>
          </div>
        )}
      </div>
